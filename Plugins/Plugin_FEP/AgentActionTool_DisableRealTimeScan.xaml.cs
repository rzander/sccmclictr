...
namespace AgentActionTools
{
    ...
    /// </summary>
    public partial class AgentActionTool_FEP_Disable : System.Windows.Controls.UserControl
    {
        public SCCMAgent oAgent;
        
        public AgentActionTool_FEP_Disable()
        {
            InitializeComponent();
        ...
        private void btQuickScan_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                oAgent.Client.GetStringFromPS("Set-MpPreference -DisableRealtimeMonitoring $true");
            }
            catch(Exception ex)
            {
