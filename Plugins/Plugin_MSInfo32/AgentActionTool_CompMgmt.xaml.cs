...
namespace AgentActionTools
{
    ...
    public partial class AgentActionTool_CompMgmt : UserControl
    {
        ...
        {
            InitializeComponent();
            btOpenMSInfo.IsEnabled = SCCMCliCtr.Customization.CheckLicense();
            if (!btOpenMSInfo.IsEnabled)
            {
                btOpenMSInfo.ToolTip = "Please make a donation to get access to this feature !";
            }
        }
